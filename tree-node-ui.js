...
Tree.Classes.NodeUI.prototype.buildModelUI = function() {
    ...
    this.refs.label.title = this.treeUI.getNodePath(this) + "\rcreated: " + this.model.created + "\rmodified:" + this.model.modified;
    // node modifiers
    if (this.model.hidden)  Tree.addClass(this.refs.root, 'hidden');
    if (this.model.disabled) Tree.addClass(this.refs.root, 'faded');
...
Tree.Classes.NodeUI.prototype.finishEdit = function(cancelChanges) {
    ...
    if (!cancelChanges) this.model.name = this.refs.labelEditor.value;
